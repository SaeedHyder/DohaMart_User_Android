...
public class RateTechnicianFragment extends BaseFragment {
    ...
    public static RateTechnicianFragment newInstance(Service serviceEnt) {
        Bundle args = new Bundle();
    ...
    public static RateTechnicianFragment newInstance(Subscription subscriptionEnt) {
        Bundle args = new Bundle();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            if (jsonString != null) {
                serviceEntity = new Gson().fromJson(jsonString, Service.class);
            }
